...
var s = n(function(e2, t2) {
  ...
  e2.exports = (r2 = (n2 = s).lib.Base, o2 = n2.enc.Utf8, void (n2.algo.HMAC = r2.extend({ init: function(e3, t3) {
    e3 = this._hasher = new e3.init(), "string" == typeof t3 && (t3 = o2.parse(t3));
...
function v(e2, t2) {
  k[e2] || (k[e2] = {}), u(t2) && Object.keys(t2).forEach((n2) => {
    w.indexOf(n2) > -1 && function(e3, t3, n3) {
      let s2 = k[e3][t3];
      s2 || (s2 = k[e3][t3] = []), -1 === s2.indexOf(n3) && "function" == typeof n3 && s2.push(n3);
    }(e2, n2, t2[n2]);
  });
}
function S(e2, t2) {
...
function O() {
  ...
  return b = { PLATFORM: d, OS: n2, APPID: m, DEVICEID: t2, CLIENT_SDK_VERSION: "1.0.25" }, { ...b, LOCALE: e2 };
}
...
var D = class {
  ...
  setupRequest(e2, t2) {
    ...
    return "auth" !== t2 && (n2.token = this.accessToken, s2["x-basement-token"] = this.accessToken), s2["x-serverless-sign"] = E.sign(n2, this.config.clientSecret), { url: this.config.requestUrl, method: "POST", data: n2, dataType: "json", header: s2 };
  }
  getAccessToken() {
  ...
  uploadFileToOSS({ url: e2, formData: t2, name: n2, filePath: s2, fileType: r2, onUploadProgress: o2 }) {
    return new Promise((i2, a2) => {
      ...
      "function" == typeof o2 && c2 && "function" == typeof c2.onProgressUpdate && c2.onProgressUpdate((e3) => {
  ...
  getTempFileURL({ fileList: e2 } = {}) {
    return new Promise((t2, n2) => {
      Array.isArray(e2) && 0 !== e2.length || n2(new I({ code: "INVALID_PARAM", message: "fileList\u7684\u5143\u7D20\u5FC5\u987B\u662F\u975E\u7A7A\u7684\u5B57\u7B26\u4E32" })), t2({ fileList: e2.map((e3) => ({ fileID: e3, tempFileURL: e3 })) });
    });
  }
};
var q = { init(e2) {
...
const R = "undefined" != typeof location && "http:" === location.protocol ? "http:" : "https:";
var L;
!function(e2) {
...
const Z = new class {
  ...
  fire(e2, t2) {
    ...
    const n2 = "string" == typeof e2 ? new G(e2, t2 || {}) : e2;
    const s2 = n2.name;
    if (this._listens(s2)) {
      n2.target = this;
  ...
  e2[t2] = function(t3) {
    ...
    return i2 && (() => {
      ...
      if (e3 = i2, "[object FormData]" !== Object.prototype.toString.call(e3))
        ...
        for (const e4 in r2)
          i2.append(e4, r2[e4]);
    })(), t3.headers = { ...t3.headers || {}, ...o2 }, s2.call(e2, t3);
  };
}
function de() {
...
class fe {
  ...
  async _refreshAccessToken() {
    ...
    if (a2.data.code) {
      ...
      if ("SIGN_PARAM_INVALID" === e3 || "REFRESH_TOKEN_EXPIRED" === e3 || "INVALID_REFRESH_TOKEN" === e3) {
        if (this._cache.getStore(s2) === ce.ANONYMOUS && "INVALID_REFRESH_TOKEN" === e3) {
  ...
  async request(e2, t2, n2) {
    ...
    const o2 = { action: e2, env: this.config.env, dataVersion: "2019-08-16", ...t2 };
    if (-1 === ue.indexOf(e2)) {
    ...
    if ("storage.uploadFile" === e2) {
      i2 = new FormData();
      for (let e3 in i2)
        i2.hasOwnProperty(e3) && void 0 !== i2[e3] && i2.append(e3, o2[e3]);
      r2 = "multipart/form-data";
    } else {
      r2 = "application/json", i2 = {};
      for (let e3 in o2)
        void 0 !== o2[e3] && (i2[e3] = o2[e3]);
    }
    ...
    l2 && (f2 += l2);
    const p2 = await this.post({ url: f2, data: i2, ...a2 }), g = p2.header && p2.header["x-tcb-trace"];
    if (g && this._localCache.setStore(s2, g), 200 !== Number(p2.status) && 200 !== Number(p2.statusCode) || !p2.data)
      throw new Error("network request error");
    return p2;
  }
  async send(e2, t2 = {}) {
    const n2 = await this.request(e2, t2, { onUploadProgress: t2.onUploadProgress });
    if ("ACCESS_TOKEN_EXPIRED" === n2.data.code && -1 === ue.indexOf(e2)) {
...
const Ae = function(e2, t2) {
  ...
  return n2.send("storage.getUploadMetadata", { path: s2 }).then((e3) => {
    ...
    n2.upload({ url: a2, data: f2, file: r2, name: s2, fileType: i2, onUploadProgress: o2 }).then((e4) => {
      201 === e4.statusCode ? t2(null, { fileID: h2, requestId: d2 }) : t2(new Error(`STORAGE_REQUEST_FAIL: ${e4.data}`));
    }).catch((e4) => {
      t2(e4);
    });
  }).catch((e3) => {
...
class xe {
  ...
  init(e2) {
    switch (K.adapter || (this.requestClient = new K.adapter.reqClass({ timeout: e2.timeout || 5e3, timeoutMsg: `\u8BF7\u6C42\u5728${(e2.timeout || 5e3) / 1e3}s\u5185\u672A\u5B8C\u6210\uFF0C\u5DF2\u4E2D\u65AD` })), this.config = { ...Ce, ...e2 }, true) {
  ...
  auth({ persistence: e2 } = {}) {
    ...
    return t2 !== this.config.persistence && (this.config.persistence = t2), function(e3) {
      const { env: t3 } = e3;
      V[t3] = new J(e3), Y[t3] = new J({ ...e3, persistence: "local" });
  ...
  upload(e2) {
    return new Promise((t2, n2) => {
      const { url: s2, file: r2, data: o2, headers: i2, fileType: a2 } = e2, c2 = C.uploadFile({ url: qe("https:", s2), name: "file", formData: Object.assign({}, o2), filePath: r2, fileType: a2, header: i2, success(e3) {
        ...
        200 === e3.statusCode && o2.success_action_status && (n3.statusCode = parseInt(o2.success_action_status, 10)), t2(n3);
      }, fail(e3) {
...
var He = class extends D {
  ...
  setupRequest(e2, t2) {
    const n2 = Object.assign({}, e2, { spaceId: this.config.spaceId, timestamp: Date.now() }), s2 = { "Content-Type": "application/json" };
    "auth" !== t2 && (n2.token = this.accessToken, s2["x-basement-token"] = this.accessToken), s2["x-serverless-sign"] = E.sign(n2, this.config.clientSecret);
    const r2 = O();
...
\u8BE6\u7EC6\u4FE1\u606F\uFF1A${s4}`), r3(o4);
      ...
      return "number" == typeof a2 && Object.defineProperty(e3.result, "affectedDocs", { get: () => (console.warn("affectedDocs\u4E0D\u518D\u63A8\u8350\u4F7F\u7528\uFF0C\u8BF7\u4F7F\u7528inserted/deleted/updated/data.length\u66FF\u4EE3"), a2) }), T(A("database", "success"), e3).then(() => T(A("database", "complete"), e3)).then(() => (r2(e3, null), Promise.resolve(e3)));
    }, (e3) => {
...
lt = "function" != typeof atob ? function(e2) {
  if (e2 = String(e2).replace(/[\t\n\f\r ]+/g, ""), !ft.test(e2))
    throw new Error("Failed to execute 'atob' on 'Window': The string to be decoded is not correctly encoded.");
  var t2;
  e2 += "==".slice(2 - (3 & e2.length));
  for (var n2, s2, r2 = "", o2 = 0; o2 < e2.length; )
    t2 = dt.indexOf(e2.charAt(o2++)) << 18 | dt.indexOf(e2.charAt(o2++)) << 12 | (n2 = dt.indexOf(e2.charAt(o2++))) << 6 | (s2 = dt.indexOf(e2.charAt(o2++))), r2 += 64 === n2 ? String.fromCharCode(t2 >> 16 & 255) : 64 === s2 ? String.fromCharCode(t2 >> 16 & 255, t2 >> 8 & 255) : String.fromCharCode(t2 >> 16 & 255, t2 >> 8 & 255, 255 & t2);
  return r2;
} : atob;
var gt = t(n(function(e2, t2) {
  ...
  t2.initChooseAndUploadFile = function(e3) {
    return function(t3 = { type: "all" }) {
      return "image" === t3.type ? o2(e3, function(e4) {
      ...
      }(t3), t3) : "video" === t3.type ? o2(e3, function(e4) {
...
function yt(e2) {
  return { props: { localdata: { type: Array, default: () => [] }, options: { type: [Object, Array], default: () => ({}) }, spaceInfo: { type: Object, default: () => ({}) }, collection: { type: [String, Array], default: "" }, action: { type: String, default: "" }, field: { type: String, default: "" }, orderby: { type: String, default: "" }, where: { type: [String, Object], default: "" }, pageData: { type: String, default: "add" }, pageCurrent: { type: Number, default: 1 }, pageSize: { type: Number, default: 20 }, getcount: { type: [Boolean, String], default: false }, gettree: { type: [Boolean, String], default: false }, gettreepath: { type: [Boolean, String], default: false }, startwith: { type: String, default: "" }, limitlevel: { type: Number, default: 10 }, groupby: { type: String, default: "" }, groupField: { type: String, default: "" }, distinct: { type: [Boolean, String], default: false }, foreignKey: { type: String, default: "" }, loadtime: { type: String, default: "auto" }, manual: { type: Boolean, default: false } }, data: () => ({ mixinDatacomLoading: false, mixinDatacomHasMore: false, mixinDatacomResData: [], mixinDatacomErrorMessage: "", mixinDatacomPage: {} }), created() {
    ...
    h2 && (n2 = n2.orderBy(h2));
    const l2 = void 0 !== t2.pageCurrent ? t2.pageCurrent : this.mixinDatacomPage.current, d2 = void 0 !== t2.pageSize ? t2.pageSize : this.mixinDatacomPage.size, f2 = void 0 !== t2.getcount ? t2.getcount : this.getcount, p2 = void 0 !== t2.gettree ? t2.gettree : this.gettree, g = void 0 !== t2.gettreepath ? t2.gettreepath : this.gettreepath, m2 = { getCount: f2 }, y2 = { limitLevel: void 0 !== t2.limitlevel ? t2.limitlevel : this.limitlevel, startWith: void 0 !== t2.startwith ? t2.startwith : this.startwith };
...
function kt(e2) {
  ...
  e2.initUniCloudStatus = "pending", e2.initUniCloud = t2.then(() => s2.getLoginState()).then((e3) => e3 ? Promise.resolve() : s2.signInAnonymously()).then(() => {
    ...
    if (t3)
      ...
      let n4 = "";
      "remote" === e2.debugInfo.initialLaunchType ? (e2.debugInfo.forceRemote = true, n4 = "\u5F53\u524D\u5BA2\u6237\u7AEF\u548CHBuilderX\u4E0D\u5728\u540C\u4E00\u5C40\u57DF\u7F51\u4E0B\uFF08\u6216\u5176\u4ED6\u7F51\u7EDC\u539F\u56E0\u65E0\u6CD5\u8FDE\u63A5HBuilderX\uFF09\uFF0CuniCloud\u672C\u5730\u8C03\u8BD5\u670D\u52A1\u4E0D\u5BF9\u5F53\u524D\u5BA2\u6237\u7AEF\u751F\u6548\u3002\n- \u5982\u679C\u4E0D\u4F7F\u7528uniCloud\u672C\u5730\u8C03\u8BD5\u670D\u52A1\uFF0C\u8BF7\u76F4\u63A5\u5FFD\u7565\u6B64\u4FE1\u606F\u3002\n- \u5982\u9700\u4F7F\u7528uniCloud\u672C\u5730\u8C03\u8BD5\u670D\u52A1\uFF0C\u8BF7\u5C06\u5BA2\u6237\u7AEF\u4E0E\u4E3B\u673A\u8FDE\u63A5\u5230\u540C\u4E00\u5C40\u57DF\u7F51\u4E0B\u5E76\u91CD\u65B0\u8FD0\u884C\u5230\u5BA2\u6237\u7AEF\u3002\n- \u5982\u679C\u5728HBuilderX\u5F00\u542F\u7684\u72B6\u6001\u4E0B\u5207\u6362\u8FC7\u7F51\u7EDC\u73AF\u5883\uFF0C\u8BF7\u91CD\u542FHBuilderX\u540E\u518D\u8BD5\n- \u68C0\u67E5\u7CFB\u7EDF\u9632\u706B\u5899\u662F\u5426\u62E6\u622A\u4E86HBuilderX\u81EA\u5E26\u7684nodejs") : n4 = "\u65E0\u6CD5\u8FDE\u63A5uniCloud\u672C\u5730\u8C03\u8BD5\u670D\u52A1\uFF0C\u8BF7\u68C0\u67E5\u5F53\u524D\u5BA2\u6237\u7AEF\u662F\u5426\u4E0E\u4E3B\u673A\u5728\u540C\u4E00\u5C40\u57DF\u7F51\u4E0B\u3002\n- \u5982\u9700\u4F7F\u7528uniCloud\u672C\u5730\u8C03\u8BD5\u670D\u52A1\uFF0C\u8BF7\u5C06\u5BA2\u6237\u7AEF\u4E0E\u4E3B\u673A\u8FDE\u63A5\u5230\u540C\u4E00\u5C40\u57DF\u7F51\u4E0B\u5E76\u91CD\u65B0\u8FD0\u884C\u5230\u5BA2\u6237\u7AEF\u3002\n- \u5982\u679C\u5728HBuilderX\u5F00\u542F\u7684\u72B6\u6001\u4E0B\u5207\u6362\u8FC7\u7F51\u7EDC\u73AF\u5883\uFF0C\u8BF7\u91CD\u542FHBuilderX\u540E\u518D\u8BD5\n- \u68C0\u67E5\u7CFB\u7EDF\u9632\u706B\u5899\u662F\u5426\u62E6\u622A\u4E86HBuilderX\u81EA\u5E26\u7684nodejs", t4(n4);
    }
  }).then(() => {
...
let vt = new class {
  init(e2) {
    let t2 = {};
    const n2 = false !== e2.debugFunction && l && "app-plus" === d;
    switch (e2.provider) {
      case "tencent":
